...
public class LRUpdateable extends BRUpdateable{
	...
	public LRUpdateable(boolean first, boolean gram, UpdateableClassifier classifier, int MeasureLength, int inputN, int hiddenN, String xmlOriginal, String xmlReduced, String ActivationFunc, double Hthresh, double Tthresh, double delta) {
	 ...
	 */
	public LRUpdateable(boolean first, double[][] iw, double[] b, UpdateableClassifier classifier, int MeasureLength, int inputN, int hiddenN, String xmlOriginal, String xmlReduced, String ActivationFunc, double Hthresh, double Tthresh, double delta) {
		super(classifier, MeasureLength, first);
		NumInputNeuron = inputN;
		NumHiddenNeuron = hiddenN;
		originalPath = xmlOriginal;
