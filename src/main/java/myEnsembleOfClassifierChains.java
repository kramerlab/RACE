...
public class myEnsembleOfClassifierChains extends TransformationBasedMultiLabelLearner {
     ...
     */
    protected myClassifierChain[] ensemble;
    /**
     ...
     * Default constructor
     */
    public myEnsembleOfClassifierChains() {
     ...
     */
    public myEnsembleOfClassifierChains(Classifier classifier, int aNumOfModels,
        ...
        ensemble = new myClassifierChain[aNumOfModels];
        rand = new Random(1);
    }
    ...
    protected void buildInternal(MultiLabelInstances trainingSet) throws Exception {
        ...
        for (int i = 0; i < numOfModels; i++) {
            ...
            ensemble[i] = new myClassifierChain(baseClassifier, chain);
