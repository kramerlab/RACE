...
//	static ArrayList<Integer> Tp = new ArrayList<Integer>(), Tn = new ArrayList<Integer>(), Fp = new ArrayList<Integer>(), Fn = new ArrayList<Integer>();
	...
	static double[][] IW; 
	static double[] bias;
	public OnlineLabelReduction(double[][] IW , double[] bias){
		this.IW = IW;
		this.bias = bias;
	}
	...
	public static long runOnDataset(boolean first, boolean gram, MultiLabelInstances dataset, String xmlPath, String newXmlPath, String threshPath, int NumHiddenNeuron, 
		...
		LR = new LRUpdateable(first, gram, classifier, measures.size(), dataset.getNumLabels(), NumHiddenNeuron, xmlPath, newXmlPath, activationFun, Hthresh, Tthresh,d);
