...
public abstract class AbstractMultiLabelClassifier extends AbstractClassifier implements MultiLabelClassifier {
	 ...
	 */
	public static void evaluation(MultiLabelClassifier h, String args[], PrintWriter pw) {
		runClassifier(h,args,pw);
	}
	 ...
	 * @param	args	Command-line options.
	 */
	public static void runClassifier(MultiLabelClassifier h, String args[], PrintWriter pw) {
			if (h instanceof UpdateableClassifier) {
				...
				try {
					Evaluation.runExperiment(h,args,pw);
				} catch(Exception e) {
					System.err.println("\n"+e);
					//e.printStackTrace();
